...
if(isset($_POST['submit']))
{
  ...
  if ($name !='' && $price !='' && $description !='' ) {
    ...
    echo $query2 = "INSERT INTO cars (user_id, car_make, car_model, car_mileage)
                VALUES('$_SESSION[id]','$car_make', '$car_model','$car_mileage'); ";
    echo $query3 = "INSERT INTO address (user_id, city, state)
                  VALUES('$_SESSION[id]','$city', '$state'); ";
